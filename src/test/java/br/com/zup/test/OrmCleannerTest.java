...
public class OrmCleannerTest extends PlexusTestCase {
	...
	static {
		...
		EXTRACT_JAVA_DIRECTORY = new File(new File(DEFAULT_WRITE_DIRECTORY), "src/main/java/br/com/ctbc" );
	}
...
//		files.add( new File(EXTRACT_JAVA_DIRECTORY, "/model/subModel/Agreement.java") );
//		
